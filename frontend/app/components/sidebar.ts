  ...
  // Define menus for different roles
    ...
    admin: [
      ...
      },
      {
        ...
        subItems: [
          ...
          { title: 'Draft', link: '/admin/blog-management/view?status=draft' },
          { title: 'Published', link: '/admin/blog-management/view?status=published' },
          { title: 'Archived', link: '/admin/blog-management/view?status=archived' },
        ],
      },
      {
        title: 'Accounting',
    ...
    author: [
      ...
      },
      {
        ...
        icon: 'fa-envelope',
        subItems: [
          { title: 'Messages', link: '/author/chat' },
        ],
      },
      {
        title: 'Blog Management',
        icon: 'fa-blog',
        subItems: [
          { title: 'New', link: '/author/blog-management/new' },
          { title: 'Draft', link: '/author/blog-management/view?status=draft' },
          { title: 'Published', link: '/author/blog-management/view?status=published' },
          { title: 'Archived', link: '/author/blog-management/view?status=archived' },
        ],
      },
    ],
    customer: [
      ...
      },
      {
        ...
        icon: 'fa-envelope',
        subItems: [
          { title: 'Messages', link: '/customer/chat' },
        ],
      },
      {
        title: 'Invoices',
